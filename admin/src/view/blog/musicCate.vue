<template>
    <div class="c_right_box">
        <div class="c_right_top">
            ...
            <router-link to="musicCate" class="on">歌曲分类</router-link>
...
export default {
    ...
    methods : {
        // 加载数据
		appData () {
            ajax('blog/musicCate',{page:this.page} , rs => {
        ...
        // 提交
        submit () {
            ajax('blog/musicCateSubmit', this.form , rs => {
                if(rs.ret == 1){
